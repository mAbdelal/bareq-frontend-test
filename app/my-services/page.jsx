...
import { MyServiceCard } from "@/components/ui/ServiceCard";
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                ...
                // Fetch my services
                const servicesRes = await fetchWithAuth(`${process.env.NEXT_PUBLIC_BASE_URL}/services/my`);
            ...
            <div className="flex flex-col lg:flex-row gap-6">
                ...
                <div className="w-full h-fit lg:w-1/4 flex flex-col items-center gap-4 bg-white shadow-lg rounded-2xl p-6 relative border border-gray-100">
                    ...
                    <div className="flex items-center gap-2 text-yellow-500 mt-1">
                        ...
                        <span className="text-label text-sm">({academic.ratings_count || 0})</span>
                    </div>
                ...
                <div className="w-full lg:w-3/4 flex flex-col gap-6">
                    {services.length === 0 ? (
                        <p className="text-label text-lg text-center mt-20">لا توجد خدمات مفعلة بعد</p>
                    ) : (
